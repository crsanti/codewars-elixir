defmodule Greeter do
  ...
  #   if Map.has_key?(@greetings, language) do
  #     @greetings[language]
  #   else
  #     @greetings["default"]
  #   end
  ...
  # Important note about why strings are used as key instead of atom:
  # Atoms never gets garbage collected, so if you create tons of String.to_atom(str)
  def greet(language) do
    @greetings[language] || @greetings["english"]
    # Or even
    # Map.get(@greetings, language, @greetings["english"])
  end
end
