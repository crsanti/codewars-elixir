defmodule Wall do
  ...
  # To help decide those things you've decided to write a function, is_divisible() that will
  # tell you whether a wall of a certain length can exactly fit an integer number of pixels
  # of a certain length.
  # Your function should take two arguments: the size of the wall in millimeters and the size of a pixel
  # in millimeters. It should return True if you can fit an exact number of pixels on the wall,
