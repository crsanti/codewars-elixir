defmodule HeroRoot do
  ...
  defp int_rac(_n, nextX, prevX, counts) when abs(prevX - nextX) < 1, do: counts
  defp int_rac(n, nextX, _prevX, counts) do
    int_rac(n, floor(floor(nextX + n / nextX) / 2), nextX, counts + 1)
  end
end
